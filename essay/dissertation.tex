...
These frames are packed into Group of Pictures (GOP\nomenclature{GOP}{Gropu of Pictures}) structures. A typical GOP structure is \texttt{IBBPBBP$\ldots$PBBI}. Since B-frames and P-frames are much smaller than I-frames, the complete video stream uses much less bandwidth.
