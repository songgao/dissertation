...
The implementations of \texttt{shouldDF()} and \texttt{chooseKFID} are particularly tricky, and requires to be guided by tests in order to achieve good performance. The following sections of this chapter explains this process, in which an adaptive ICTL algorithm is designed.

\section{Performance Study and Discussion}
